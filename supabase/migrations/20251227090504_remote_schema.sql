...
ALTER TABLE ONLY "public"."meal_plans"
    ADD CONSTRAINT "meal_plans_planned_date_key" UNIQUE ("planned_date");



CREATE POLICY "Enable CRUD for authenticated users only" ON "public"."meal_plans" TO "authenticated" USING (true);
